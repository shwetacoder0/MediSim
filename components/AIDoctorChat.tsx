...
export default function AIDoctorChat({ onClose, patientContext }: AIDoctorChatProps) {
  ...
  const startConversation = async () => {
    try {
      ...
      // Make the exact POST request as specified
      ...
      // Set the conversation data which will trigger the WebView to load
      ...
      Alert.alert(
        'Connection Error', 
        'Failed to connect to AI Doctor. Please check your internet connection and try again.',
        [
          { text: 'Try Again', onPress: () => startConversation() },
  ...
  // Show start screen when not connected
